...
class PlacementCost(object):
    ...
    def get_fake_nets(self):
        """
        Stub: circuit_training environments assume get_fake_nets exists.
        Returns an empty list for this open-source variant since fake nets aren't implemented.
        """
        return []
    ...
    def set_congestion_grid(self, grid_col: int, grid_row: int) -> None:
        """Stub: delegates to set_placement_grid."""
        self.set_placement_grid(grid_col, grid_row)
    ...
    def get_congestion_grid_num_columns_rows(self) -> Tuple[int, int]:
        """
        Return congestion grid col/row. Delegates to get_grid_num_columns_rows.
        """
        return self.get_grid_num_columns_rows()
